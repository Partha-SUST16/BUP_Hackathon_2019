...
public class Notification extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alarmtext = findViewById(R.id.textalarmId);

        Button buttonTimePicker = findViewById(R.id.TimePickerButtonId);
        ...
        Button buttonCancelAlarm = findViewById(R.id.CancelAlarmButtonId);
